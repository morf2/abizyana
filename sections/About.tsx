  ...
  return (
    <section id="about" className="content-section about-section">
      <div className="page-shell">
        ...
        <p className="section-lead about-services">
          Берём проект от идеи до запуска: продумываем структуру, создаём
          веб-дизайн, собираем сайт и подключаем автоматизацию. Работаем с
          бизнесом по всей России онлайн, а базируемся в Барнауле.
        </p>
      </div>
    </section>
  );
