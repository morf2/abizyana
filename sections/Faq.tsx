const questions = [
  ...
  {
    question: "Можно заказать сайт в Барнауле?",
    answer:
      "Да. Разрабатываем в Барнауле лендинги и сайты для бизнеса: продумываем структуру, создаём дизайн, собираем и запускаем проект.",
  },
];
