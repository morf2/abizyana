const questions = [
  ...
  {
    question: "Вы работаете только в Барнауле?",
    answer:
      "Нет. Мы базируемся в Барнауле, а проекты ведём онлайн с клиентами из разных городов России: обсуждаем задачу, показываем этапы и запускаем готовый продукт дистанционно.",
  },
];
