...
export const metadata: Metadata = {
  ...
  description:
    "Услуги студии «Абизяна» в Барнауле: создание сайтов и лендингов, веб-дизайн, Telegram-боты и автоматизация бизнеса.",
  alternates: { canonical: "/uslugi/" },
  openGraph: {
    title: "Услуги студии «Абизяна» в Барнауле",
    description:
      "Создание сайтов и лендингов, веб-дизайн, Telegram-боты и автоматизация бизнеса.",
    url: "/uslugi/",
  },
};
...
const jsonLd = {
  ...
  description:
    "Создание сайтов, веб-дизайн, Telegram-боты и автоматизация бизнеса в Барнауле.",
      ...
      <section className="service-index-hero" id="top">
        <div className="page-shell">
          ...
          <p>
            ...
            разработать бота или убрать ручную рутину.
          </p>
        </div>
      </section>
